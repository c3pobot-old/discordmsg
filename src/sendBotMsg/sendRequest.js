...
module.exports = async(body = {})=>{
  try{
    let opts = {method: 'POST', timeout: 120000, compress: true, headers: {"Content-Type": "application/json"}, body: JSON.stringify(body)}
    let res = await requestWithRetry(path.join(BOT_BRIDGE_URI, 'cmd'), opts)
